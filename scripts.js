    ...
    try{
        ...
        if(amountValue !== "") {
            ...
            coinInfo.innerHTML = `<p class="info">El precio es: <span class="price">${price}</span>$</p>
                ...
                <p class="info">Variación en 24H: <span class="price">${porcent24h}%</span></p>
                <p class="info">Puedes comprar: <span class="price">${result.toFixed(5)} ${cryptoSelected}</span> unidades</p>`;
        } else  {
            coinInfo.innerHTML = `<p class="info">El precio es: <span class="price">${price}</span>$</p>
                <p class="info">El precio más alto es: <span class="price">${high24h}</span>$</p>
                <p class="info">El precio más bajo es: <span class="price">${low24h}</span>$</p>
